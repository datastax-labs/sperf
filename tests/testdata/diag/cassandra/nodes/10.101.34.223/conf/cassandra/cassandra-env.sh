...
JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=10.101.34.223"
#
# see
...
JVM_OPTS="$JVM_OPTS -javaagent:/home/automaton/jolokia-jvm-agent.jar=host=ip-10-101-34-223.srv101.dsinternal.org"
#AUTOMATON_USER_JOLOKIA_END_JVM_OPTS
JVM_OPTS="$JVM_OPTS -Dcassandra.consistent.rangemovement=false"
#AUTOMATON_USER_HANDLE_JVM_OPTIONS_BEGIN_JVM_OPTS
JVM_OPTS="$JVM_OPTS -Dmx4jaddress=10.101.34.223"
